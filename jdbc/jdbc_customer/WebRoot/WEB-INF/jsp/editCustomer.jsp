...
<html>
 ...
 <body style="text-align:center;">
    <form action="${pageContext.request.contextPath }/servlet/EditCustomerServlet" id="form" method="post" onsubmit="return makepre()">
	    <table border="1" width="50%">
	    	<!-- 通过隐藏域将要修改用户的id带到doPost,然后根据该id将修改后的数据更新到数据库 -->
	    	...
	    	<tr>
	    		<td>生日：</td>
	    		<td>
	    			<input name="birthday" type="text" id="birthday" title="点击选择" onClick="showCalendar(this.id)" value="${c.birthday }"> 
	    		</td>
	    	</tr>
	    	<tr>
	    		<td>手机号：</td>
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<c:forEach var="preference" items="${preferences}">
	    				<input type="checkbox" name="pre" value="${preference }" ${fn:contains(c.preference,preference)?'checked':'' }>${preference }
	    			</c:forEach>
	    		</td>
	    	</tr>
	    	<tr>
